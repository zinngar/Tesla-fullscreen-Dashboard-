...
1. **Start the App:**
   ...
   - Automatically expose and map it to port **`5050`** on the host.
...
3. **Bookmark on Tesla:**
   Open `http://<YOUR_SERVER_IP>:5050` in your Tesla's browser and bookmark the page for quick, one-click access.
...
- **Port Mapping:** Host `5050` maps to Container `5000`
